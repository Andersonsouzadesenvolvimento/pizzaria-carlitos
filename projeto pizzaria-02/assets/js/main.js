...
sr.reveal(`.home__data .recipe__list, .contato__data`,  {origin: 'right'})
sr.reveal(`.about__img, .recipe__img, .contato__image`, {origin:  'left'})
sr.reveal(`.produto__card`, {interval: 100})
